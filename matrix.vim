...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 29 + 119) / 238)
exe 'vert 2resize ' . ((&columns * 208 + 119) / 238)
argglobal
balt main.cpp
let s:cpo_save=&cpo
set cpo&vim
...
keepjumps 3
normal! 0
lcd ~/Workspace/git/matrix
wincmd w
argglobal
if bufexists(fnamemodify("~/Workspace/git/matrix/main.cpp", ":p")) | buffer ~/Workspace/git/matrix/main.cpp | else | edit ~/Workspace/git/matrix/main.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
